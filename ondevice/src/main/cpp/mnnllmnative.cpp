...
Java_com_matrix_agent_ondevice_mnn_MNNLlmNative_nativeCountTokens(
...
Java_com_matrix_agent_ondevice_mnn_MNNLlmNative_nativeLoadLlm(
...
Java_com_matrix_agent_ondevice_mnn_MNNLlmNative_nativeReleaseLlm(
    JNIEnv* env, jclass clazz, jlong llmPtr) {
...
Java_com_matrix_agent_ondevice_mnn_MNNLlmNative_nativeTokenize(
    JNIEnv* env, jclass clazz, jlong llmPtr, jstring jtext) {
...
Java_com_matrix_agent_ondevice_mnn_MNNLlmNative_nativeDetokenize(
...
extern "C" JNIEXPORT jstring JNICALL
Java_com_matrix_agent_ondevice_mnn_MNNLlmNative_nativeGenerate(
...
static jboolean runStreamGenerationWithInputIds(
    ...
    try {
        ...
        setCancelFlag(llmPtr, false);  // P0-1: 清 flag 防上一个请求的迟到 cancel 误伤本次 generate。
                                       // 早到 cancel（generate 启动前）由 Java 层 doDecide generate 前检查拦截。
...
extern "C" JNIEXPORT void JNICALL
Java_com_matrix_agent_ondevice_mnn_MNNLlmNative_nativeCancel(
    JNIEnv* env, jclass clazz, jlong llmPtr) {
...
extern "C" JNIEXPORT jstring JNICALL
Java_com_matrix_agent_ondevice_mnn_MNNLlmNative_nativeApplyChatTemplate(
    JNIEnv* env, jclass clazz,
    jlong llmPtr,
...
extern "C" JNIEXPORT jint JNICALL
Java_com_matrix_agent_ondevice_mnn_MNNLlmNative_nativeCountTokensWithStructuredMessages(
    JNIEnv* env, jclass clazz,
    jlong llmPtr,
    jstring jmessagesJson,
    jstring jtoolsJson) {
...
extern "C" JNIEXPORT jstring JNICALL
Java_com_matrix_agent_ondevice_mnn_MNNLlmNative_nativeDumpConfig(
    JNIEnv* env, jclass clazz, jlong llmPtr) {
...
extern "C" JNIEXPORT jstring JNICALL
Java_com_matrix_agent_ondevice_mnn_MNNLlmNative_nativeGetContextInfo(
    JNIEnv* env, jclass clazz, jlong llmPtr) {
...
extern "C" JNIEXPORT void JNICALL
Java_com_matrix_agent_ondevice_mnn_MNNLlmNative_nativeReset(
    JNIEnv* env, jclass clazz, jlong llmPtr) {
...
extern "C" JNIEXPORT jboolean JNICALL
Java_com_matrix_agent_ondevice_mnn_MNNLlmNative_nativeSetConfig(
