 ...
 * 与所有 V0.4.x 测试 fake 不需要改动;V0.5.1 / V0.6.0 接真实 AIDL/Binder/厂商 SDK Provider
...
public interface CapabilityProvider {
     ...
     * V0.5.1 / V0.6.0 接真实 Provider 时,只在 Provider 真能保证 abort 成功(例如 AIDL
     ...
     * {@link ToolResult.Status#EXECUTION_UNKNOWN} 处理。V0.5.1 / V0.6.0 接真实 Provider 时,
