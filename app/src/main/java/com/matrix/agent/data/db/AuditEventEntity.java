...
/**
 * Audit 事件——<b>预建表</b>(Entity + DAO 接口稳定,
 * 但 Audit 落库走 TrajectoryEntity,本表无实际写入路径)。
 *
 * <p>接入主路径:AgentEngine 5 个出口点先写 TrajectoryEntity,
 ...
 *
 * <p>原注释写"只写 TERMINAL"与实际状态不符——
 * 全项目无 AuditEventDao 的实际调用。统一改为"预建表 / 接入"。
 */
